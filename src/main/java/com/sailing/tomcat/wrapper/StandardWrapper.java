...
package com.sailing.tomcat.wrapper;



import com.sailing.tomcat.container.Container;
import com.sailing.tomcat.container.ContainerBase;
...
import com.sailing.tomcat.request.HttpRequestBase;
import com.sailing.tomcat.response.HttpResponseBase;
...
//            SystemLogHandler.startCapture();
        ...
        try {
            ...
            if (swallowOutput) {
                String log = "Capture";//SystemLogHandler.stopCapture();
...
//            SystemLogHandler.startCapture();
        ...
        try {
            ...
            if (swallowOutput) {
                String log = "begin capture"; //SystemLogHandler.stopCapture();
                if (log != null && log.length() > 0) {
                    if (getServletContext() != null) {
                        getServletContext().log(log);
                    } else {
