package com.sailing.tomcat.host;
...
public class StandardHost extends ContainerBase implements Deployer, Host {
     ...
     * deployment requests.
     */
    private Deployer deployer = null;//new StandardHostDeployer(this);
     ...
     */
    private String mapperClass = "com.sailing.tomcat.host.StandardHostMapper";
